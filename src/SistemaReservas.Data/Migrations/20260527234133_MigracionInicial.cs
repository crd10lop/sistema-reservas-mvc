        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Barrio = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    DireccionResidencia = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    TelefonoResidencia = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    AutorizaEnvioCorreo = table.Column<bool>(type: "bit", nullable: false),
                    AutorizaEnvioCelular = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    TipoTemporada = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoAlojamiento = table.Column<int>(type: "int", nullable: false),
                    CapacidadMaxima = table.Column<int>(type: "int", nullable: false),
                    CapacidadIncluida = table.Column<int>(type: "int", nullable: false),
                    NumeroHabitacionesInternas = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAlojamiento = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioDiaEspecial = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallesReserva_Alojamientos_AlojamientoId",
                        column: x => x.AlojamientoId,
                        principalTable: "Alojamientos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservasServicios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservasServicios_Reservas_ReservaId",
                        column: x => x.ReservaId,
                        principalTable: "Reservas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservasServicios_Servicios_ServicioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesReserva_AlojamientoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservasServicios_ReservaId",
                table: "ReservasServicios",
                column: "ReservaId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservasServicios_ServicioId",
                table: "ReservasServicios",
                column: "ServicioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Temporadas_FechaFin",
                table: "Temporadas",
                column: "FechaFin");

            migrationBuilder.CreateIndex(
                name: "IX_Temporadas_FechaInicio",
                table: "Temporadas",
                column: "FechaInicio");
        }
